...
(() => {
  ...
  const TEAM = {
    ...
    ridham: 'Ridham Rajput is Co-Founder & AI Full Stack Developer at WexForge. He builds intelligent applications with AI-powered features, backend systems and seamless integrations — making sure every experience is smart, scalable and reliable. Reach him at ridhamrajputx18@gmail.com or +91 78746 76086.',
  };
  ...
  const intents = [
    ...
    },
    {
      ...
      respond: () => ({
        text: 'WexForge was founded by two developers: Khatri Aakib (Co-Founder & Full Stack Developer) and Ridham Rajput (Co-Founder & AI Full Stack Developer). Every project is built directly by the two of them — no account managers, no hand-offs.',
